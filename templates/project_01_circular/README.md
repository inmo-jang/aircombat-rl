...
```bash
python -m tools.grade templates/project_01_circular
python -m tools.watch templates/project_01_circular                  # on screen
python -m tools.watch templates/project_01_circular --tacview        # live TacView (Windows)
```
