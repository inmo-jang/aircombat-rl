...
Shoot down an opponent that shoots back, from a start that favours neither of
...
```bash
python -m tools.grade templates/project_04_fair
python -m tools.watch templates/project_04_fair                  # on screen
python -m tools.watch templates/project_04_fair --tacview        # live TacView (Windows)
```
