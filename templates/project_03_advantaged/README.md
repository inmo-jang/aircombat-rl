# Project 03 - Advantaged

Shoot down an opponent that shoots back, from a start that favours you.
You design what the policy sees and what it is paid; the algorithm comes from
`stable-baselines3`.
...
```bash
python -m tools.grade templates/project_03_advantaged
python -m tools.watch templates/project_03_advantaged                  # on screen
python -m tools.watch templates/project_03_advantaged --tacview        # live TacView (Windows)
```
